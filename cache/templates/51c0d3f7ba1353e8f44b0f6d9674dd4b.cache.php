...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<?php echo $menu; ?><a href="http://www.mantob.com/help/list-341.html" target="_blank"><em><?php echo lang('help'); ?></em></a><span>|</span><a href="http://www.mantob.com/help/list-341.html" target="_blank"><em>字段输出</em></a><span>|</span>
	</div>
	<div class="bk10"></div>
	...
	<div class="table-list">
		...
		<tr style="color:<?php echo $group[$t['fieldname']]; ?>">
			...
			<td align="center"><img src="<?php echo SITE_URL; ?>mantob/statics/images/<?php echo $t['issystem']; ?>.gif"></td>
			<td align="center"><img src="<?php echo SITE_URL; ?>mantob/statics/images/<?php echo $t['ismain']; ?>.gif"></td>
			<td align="center"><img src="<?php echo SITE_URL; ?>mantob/statics/images/<?php echo $t['ismember']; ?>.gif"></td>
			<td align="center"><?php if ($this->ci->is_auth('admin/field/edit')) { ?><a href="javascript:;" onClick="return dr_dialog_set('<?php echo $t['disabled'] ? lang('html-161') : lang('html-162'); ?>','<?php echo dr_url('field/disabled', array('rname' => $rname, 'rid' => $rid, 'id' => $t['id'])); ?>');"><img src="<?php echo SITE_URL; ?>mantob/statics/images/<?php echo $t['disabled'] ? 0 : 1 ?>.gif"></a><?php } else { ?><img src="<?php echo SITE_URL; ?>mantob/statics/images/<?php echo $t['disabled'] ? 0 : 1 ?>.gif"></a><?php } ?></td>
			<td align="left">
			<?php if ($this->ci->is_auth('admin/field/edit')) { ?><a href="<?php echo dr_url('field/edit', array('rname' => $rname, 'rid' => $rid, 'id' => $t['id'])); ?>"><?php echo lang('edit'); ?></a>&nbsp;&nbsp;&nbsp;<?php }  if ($this->ci->is_auth('admin/field/del')) {  if ($t['issystem']) { ?><a href="javascript:;" style="color:red;"><?php echo lang('html-700'); ?></a>
                <?php } else { ?><a href="javascript:;" onClick="return dr_dialog_del('<?php echo lang('015'); ?>','<?php echo dr_url('field/del', array('rname' => $rname,'rid' => $rid, 'id' => $t['id'])); ?>');"><?php echo lang('del'); ?></a>
                <?php }  } ?>
			</td>
		</tr>
		<?php } } ?>
