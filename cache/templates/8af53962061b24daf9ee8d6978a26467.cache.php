...
<!--banner-->
<?php $return = $this->list_tag("action=navigator type=4 pid=0"); if ($return) extract($return); $count=count($return); if (is_array($return)) { foreach ($return as $key=>$t) {  if ($t['id'] == 37) { ?>
<section class="from-wrap wb100" style="background-image: url('<?php echo dr_thumb($t['thumb']); ?>')" />
<?php }  } } ?>
    <!--from box-->
   <div class="from-box wb100">
       <div class="from-main m-auto">
           <form action="/index.php?c=form_1_1" method="post" name="myform" id="myform">
           <div class="from-bo">
               <dvi class="from-nav">
                    <a href="index.php?c=form_1_1" class="on">
                        在线订单
                    </a>
                    <a href="index.php?c=form_1_2">
                        产品定制 
                    </a>
                    <div class="clear"></div>
               </dvi>
               <div class="from-p">
                   请认真选择您所要咨询或购买的产品，以便我们更好的为您服务！（说明：带＊选项为必填项目）
               </div>
               <div class="from-lab-box">
                   <ul>
                       ...
                       <li class="li2">
                           ...
                           <input type="text" required="required" name="data[danweimingcheng]">
                       </li>
                       <li class="li1" >
                           <span class="s1">
                               您的姓名＊
                           </span>
                           <input type="text" required="required" name="data[nindexingming]">
                       </li>
                       <li class="li2">
                           <span class="s1" >
                               联系电话＊
                   ...
                   <div class="textarea-box">
                       <textarea  class="textarea" required="required" name="data[xiangqing]" ></textarea>
                    </div>
