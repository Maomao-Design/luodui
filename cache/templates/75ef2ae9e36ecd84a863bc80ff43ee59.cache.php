...
<!--banner-->
<section class="zhibao-banner-wrap wb100" style="background-image: url('<?php echo dr_thumb($thumb); ?>')">
...
<section class="zhibao-shouhou-fuwu-wrap wb100" style="background-image: url('<?php echo dr_thumb($t['thumb']); ?>')" />
<?php }  } } ?>
