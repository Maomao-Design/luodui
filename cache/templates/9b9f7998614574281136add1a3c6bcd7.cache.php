...
<div class="subnav">
    ...
    <div class="table-list col-tab">
       ...
       <tr>
			...
			<td>
            <label><input  type="radio" name="mantype" <?php if ($mantype == 0) { ?> checked<?php } ?> value="0" class="nomantype" onclick="man_type_hide()" />导航</label>
            <br/>
            <label><input  type="radio" name="mantype" <?php if ($mantype == 1) { ?> checked<?php } ?> value="1" class="yesmantype" onclick="man_type_show(1)" />&nbsp;1 （背景图片 + 内容图片 + 按钮链接）</label>
            <br/>
            <label><input  type="radio" name="mantype" <?php if ($mantype == 2) { ?> checked<?php } ?> value="2" class="yesmantype" onclick="man_type_show(2)"  />&nbsp;2 （背景图片 + 大标题文本 + 描述文本 + 按钮链接）</label>
             <br/>
            <label><input  type="radio" name="mantype" <?php if ($mantype == 3) { ?> checked<?php } ?> value="3" class="yesmantype" onclick="man_type_show(3)"  />&nbsp;3 （背景视频 + 大标题文本 + 描述文本 + 按钮链接）</label>
        ...
        <tr class="nav_0 nav_c mantype_box mantype_1 mantype_2">
            ...
            <td>
                <?php echo dr_field_input('bgthumb', 'File', $field['thumb']['setting'], $data['bgthumb']); ?>
        ...
        <tr class="nav_0 nav_c mantype_box mantype_1 mantype_2">
            ...
            <td>
                <?php echo dr_field_input('mainthumb', 'File', $field['thumb']['setting'], $data['mainthumb']); ?>
        ...
        <tr class="nav_0 nav_c">
         ...
         <tr class="nav_0 nav_c mantype_box mantype_2 mantype_3">
            <th>大标题文本： </th>
            <td>
                <?php echo dr_field_input('bigtitle', 'Text', $field['title']['setting'], $data['bigtitle']); ?>
        ...
        <tr class="mantype_box mantype_3">
            ...
            <td>
                <?php echo dr_field_input('bgmpsi', 'File', $field['bgmpsi']['setting'], $data['bgmpsi']); ?>
