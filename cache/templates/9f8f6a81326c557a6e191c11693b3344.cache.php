		...
		<div class="contentList pad-10">
			<div id="cnt_0" style="display:none" class="dr_hide">
				...
				<tr>
                    ...
                    <td>
                    <input type="radio" name="data[ismain]" value="0" <?php if ($id) { ?>disabled<?php }  echo dr_set_radio('ismain', $data['ismain'], '0', TRUE); ?> />&nbsp;<label><?php echo lang('no'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="data[ismain]" value="1" <?php if ($id) { ?>disabled<?php }  echo dr_set_radio('ismain', $data['ismain'], '1'); ?> />&nbsp;<label><?php echo lang('yes'); ?></label>
				...
				<tr>
                    ...
                    <td>
                    <input type="radio" name="data[issearch]" value="0" <?php echo dr_set_radio('issearch', $data['issearch'], '0'); ?> />&nbsp;<label><?php echo lang('no'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="data[issearch]" value="1" <?php echo dr_set_radio('issearch', $data['issearch'], '1', TRUE); ?> />&nbsp;<label><?php echo lang('yes'); ?></label>
				...
				<tr>
					...
					<option value=""> -- </option>
					<?php if (is_array($ftype)) { $count=count($ftype);foreach ($ftype as $t) {  if ($iscategory && $t['id'] == 'Ueditor') { continue; } ?>
					<option value="<?php echo $t['id']; ?>" <?php if ($t['id']==$data['fieldtype']) { ?> selected="selected"<?php } ?>> <?php echo $t['name']; ?> </option>
					<?php } } ?>
					</select>
                    <span id="dr_loading" style="display:none"><img src="<?php echo SITE_URL; ?>mantob/statics/images/onLoad.gif" height="10" /></span>
					</td>
				</tr>
				<tbody id="dr_option">
				</tbody>
			...
			<div id="cnt_1" style="display:none" class="dr_hide">
				...
				<tr>
                    ...
                    <td>
                    <input type="radio" name="data[setting][validate][required]" value="0" <?php if ($data['setting']['validate']['required']==0) { ?>checked<?php } ?> onclick="set_required(0)" />&nbsp;<label><?php echo lang('no'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="data[setting][validate][required]" value="1" <?php if ($data['setting']['validate']['required']==1) { ?>checked<?php } ?> onclick="set_required(1)" />&nbsp;<label><?php echo lang('yes'); ?></label>
                    </td>
                </tr>
				...
				<tr>
                    ...
                    <td>
                    <input type="radio" name="data[setting][validate][isedit]" value="0" <?php if (!$data['setting']['validate']['isedit']) { ?>checked<?php } ?> />&nbsp;<label><?php echo lang('no'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="data[setting][validate][isedit]" value="1" <?php if ($data['setting']['validate']['isedit']) { ?>checked<?php } ?> />&nbsp;<label><?php echo lang('yes'); ?></label>
					<div class="onShow"><?php echo lang('html-225'); ?></div>
                    </td>
                </tr>
                <tr>
                    <th><?php echo lang('html-552'); ?>：</th>
                    <td>
                    <input type="radio" name="data[setting][validate][xss]" value="0" <?php if ($data['setting']['validate']['xss']==0) { ?>checked<?php } ?> />&nbsp;<label><?php echo lang('open'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="data[setting][validate][xss]" value="1" <?php if ($data['setting']['validate']['xss']==1) { ?>checked<?php } ?> />&nbsp;<label><?php echo lang('close'); ?></label><div class="onShow"><?php echo lang('html-553'); ?></div>
                    </td>
                </tr>
				<tr>
			...
			<div id="cnt_2" style="display:none" class="dr_hide">
				...
				<tr>
                    ...
                    <td>
                    <input type="radio" name="data[ismember]" value="0" <?php echo dr_set_radio('ismember', $data['ismember'], '0'); ?> />&nbsp;<label><?php echo lang('no'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="data[ismember]" value="1" <?php echo dr_set_radio('ismember', $data['ismember'], '1', TRUE); ?> />&nbsp;<label><?php echo lang('yes'); ?></label>
				...
				<tr>
                    ...
                    <td>
                    <input type="radio" name="data[disabled]" value="0" <?php echo dr_set_radio('disabled', $data['disabled'], '0', TRUE); ?> />&nbsp;<label><?php echo lang('no'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="data[disabled]" value="1" <?php echo dr_set_radio('disabled', $data['disabled'], '1'); ?> />&nbsp;<label><?php echo lang('yes'); ?></label>
